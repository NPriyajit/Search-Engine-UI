...
document.querySelector(".headlink").style.animation="linktxtop 2.5s 1.8s forwards";
...
function setAnim(){
	...
	textdata.style.animation="textdata 6s 11s ease forwards, disc 5s 25s ease forwards";
	textdata1.style.animation="rightanim 6s 24.5s ease forwards,opaq 5s 35s ease forwards";
...
function unsetAnim(){
        topdown.style.animation="topdown 5s 40s ease reverse forwards";
